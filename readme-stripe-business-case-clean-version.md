...
| Term               | Definition                                                                                  |
|--------------------|---------------------------------------------------------------------------------------------|
| **OLTP**           | Online Transaction Processing: Systems optimised for high-volume, low-latency transactions. |
| **OLAP**           | Online Analytical Processing: Systems optimised for complex queries and reporting.          |
| **NoSQL**          | Non-relational databases (e.g., MongoDB) for flexible, unstructured data.                   |
| **CDC**            | Change Data Capture: Tracking and streaming database changes (e.g., Debezium).              |
| **ETL**            | Extract, Transform, Load: Process of moving data between systems.                           |
| **dbt**            | Data Build Tool: SQL-based transformation workflows for analytics.                          |
| **SCD Type 2**     | Slowly Changing Dimension: Tracks historical changes in dimensional data.                   |
...
**© 2026 Stripe Business Case | AIA Certification Project - Bloc 2 - RNCP38777**